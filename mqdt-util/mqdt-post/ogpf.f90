...
module ogpf
    ...
    type tplabel
        ...
        character(len=len_options), allocatable :: lbltext
        character(len=len_options), allocatable :: lblcolor
        character(len=len_options), allocatable :: lblfontname
    ...
    type, public :: gpf
        ...
        character(len=len_options), allocatable  :: txtoptions    ! a long string to store all type of gnuplot options
        character(len=len_options), allocatable  :: txtscript     ! a long string to store gnuplot script
        character(len=len_options), allocatable  :: txtdatastyle  ! lines, points, linepoints
        ...
        character(len=len_options), allocatable   :: msg      !Message from plot procedures
        integer                         :: status=0 !Status from plot procedures

        !
        integer                         :: file_unit      ! file unit identifier
        character(len=len_options), allocatable   :: txtfilename    ! the name of physical file
...
contains
    ...
    subroutine write_label(this, lblname)
        ...
        ! local var
        character(len=len_options), allocatable :: lblstring
        character(len=len_options), allocatable :: lblset
        type(tplabel)                 :: label
    ...
    function color_palettes(palette_name) result(str)
        ...
        character(len=len_options), allocatable :: str
        ...
        character(len=len_options), allocatable :: pltname
    ...
    subroutine finalize_plot(this)
      ...
      !  call execute_command_line ('gnuplot -persist ' // this%txtfilename)  !   Now plot the results
        call system('gnuplot -persist ' // this%txtfilename)              !Obsolete method, use with old compilers
    ...
    pure function splitstr(str) result(spstr)
        ...
        character(len=len_options), allocatable :: spstr
        integer ::  n
        integer ::  m
        integer ::  k
    ...
    function num2str_i4(number_in)
        ...
        character(len=len_options), allocatable   :: num2str_i4
    ...
    function num2str_r4(number_in, strfmt)
        ...
        character(len=len_options), allocatable           :: num2str_r4
    ...
    function num2str_r8(number_in, strfmt)
        ...
        character(len=*), intent(in), optional  :: strfmt
        character(len=len_options), allocatable           :: num2str_r8
